...
let UploadFile = props => {
  return (
    <div>
      <div className={s.uploadFile_container}>
        <svg
          className={s.uploadFile_container__svg}
          width="17"
          height="15"
          viewBox="0 0 17 15"
          fill="none"
